...
func golangFuncsTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "golang.funcs.tmpl", size: 9127, mode: os.FileMode(420), modTime: time.Unix(946710000, 0)}
